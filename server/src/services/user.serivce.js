...
const updateService = (id,nome,email,senha,adm,idade,sexo,conquistas,foto,favoritos) => User.findOneAndUpdate({_id: id},{nome,email,senha,adm,idade,sexo,conquistas,foto,favoritos});
